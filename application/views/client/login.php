...
<body class="theme-6">
                ...
                <div class="row align-items-center text-start">
                    <div class="col-xl-6">
                        <div class="card-body w-100">
                            <div class="d-flex">
                                <h2 class="mb-3 f-w-600">Client Login</h2>
                            </div>
  ...
  <div class="input-group">
    ...
    <button type="button" class="btn btn-outline-secondary" id="togglePassword" tabindex="-1" style="border:1px solid #ced4da">
      <i class="fa-solid fa-eye" id="eyeIcon" style="font-size:14px;"></i>
    </button>
  </div>

  <div class="mb-2 mt-2 d-flex">
    <a href="<?php echo base_url('recover-password/client'); ?>" class="small text-muted" style="font-weight: bold; color:#5360c6 !important;" id="forgot-password">
      Forgot Your Password?
                    ...
                    <div class="col-xl-6 img-card-side">
                        <div class="auth-img-content">
                            <img src="<?php echo base_url(); ?>assets/images/credit_score.svg" alt="" class="img-fluid">
                            <h5 class="text-white font-weight-bold mt-5" style="color: black !important;">Your Credit Score Shapes Your Financial Future</h5>
                            <p class="text-white lead" style="color: black !important; font-size:14px !important;">A strong credit score builds trust with lenders, giving you access to better financial opportunities.</p>
                        </div>
                    </div>
  ...
  <div class="container-fluid text-center">
    ...
    <script>
        $(document).ready(function() {
            $("#loginForm").on('submit', function(e) {
                ...
                $.ajax({
                    url: "<?php echo base_url('client-login'); ?>",
                    type: 'POST',
                    data: {
                        email: email,
                        password: password,
                    ...
                    success: function(response) {
                        ...
                        } else if (data.status === "agreement_needed") {
                            Swal.fire({
                                icon: 'warning',
                                title: 'Agreement Required',
                                text: data.message
                            }).then(() => {
                                window.location.href = "<?php echo base_url('client/agreement'); ?>";
                            });
    ...
    <!-- Font Awesome (include once in <head>) -->
