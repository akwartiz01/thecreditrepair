                            ...
                            <div class="tab-pane fade" id="profile" role="tabpanel">
                                ...
                                <form id="profile_settings_form" class="settings-form" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="adminmail" name="email" value="<?php echo $client_result->sq_email; ?>" placeholder="Enter email address" readonly>
                                        ...
                                        <div class="media align-items-center">
                                            ...
                                            <div class="media-left">
                                                ...
                                                if ((!empty($client_result->profile_img))) {
                                                    ...
                                                    $client_image = $client_result->profile_img;
                                                } else {
...
<script>
    $(document).ready(function() {
        ...
        $('#current_password').on('keyup', function() {
            ...
            if (current_password !== '') {
                $.ajax({
                    url: '<?php echo base_url('client/verify_current_password'); ?>',
                    type: 'POST',
                    data: {
            ...
            if (isValid) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '<?php echo base_url('client/profile_setting'); ?>',
                            type: 'POST',
                            data: {
                                current_password: current_password,
