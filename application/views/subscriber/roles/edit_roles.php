					...
					<div class="card-body">
						<form id="add_roless" action="<?php echo $base_url; ?>admin/add-roles-permissions" method="post" autocomplete="off" enctype="multipart/form-data">
							...
							<div class="form-group">
								<label><?php echo(!empty($categories['lg_role_name']))?($categories['lg_role_name']) : 'Role Name';  ?>(<?php echo $langval->language; ?>)<span class="text-danger">*</span></label>
								<input class="form-control" type="text"  name="role_name_<?php echo $langval->id; ?>" id="role_name" value="<?php echo ($role_name)?$role_name:''; ?>" placeholder="Enter role name">
							</div>
							<?php }  ?>
							<div class="form-group">
