                        ...
                        <form id="add_client" method="post" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="email" class="form-control" id="user_id" name="user_id" value="" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <label>Fax</label>
                                        <input type="text" class="form-control" id="fax" name="fax" value="" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="title_for_portal" name="title_for_portal" value="" required>
                                    </div>
                                    <div class="col-md-6">
                                        <label>Address</label>
                            ...
                            <div class="mt-4">
                                <button type="button" class="btn btn-primary" onclick="add_new_team_member();">Submit</button>
...
<script>
    ...
    function add_new_team_member() {
        ...
        if (!isValid) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url("add_new_team_member"); ?>',
                data: formData,
