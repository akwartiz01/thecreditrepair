                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs nav-tabs-solid" role="tablist" id="profile_setting_page">
                            ...
                            <li class="nav-item home_tab" id="profile_li"> <a class="nav-link" data-toggle="tab" href="#profile" role="tab" aria-selected="false"><span class="hidden-sm-up"><i class="ti-home"></i></span>
                            ...
                            <div class="tab-pane fade" id="profile" role="tabpanel">
                                ...
                                <form id="profile_settings_form" class="settings-form" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="adminmail" name="email" value="<?php echo $subscriber_result->sq_u_email_id; ?>" placeholder="Enter email address" readonly>
                                        ...
                                        <div class="media align-items-center">
                                            ...
                                            <div class="media-left">
                                                ...
                                                if ((!empty($subscriber_result->sq_u_profile_picture))) {
                                                    ...
                                                    $_image = $subscriber_result->sq_u_profile_picture;
                                                } else {
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php $curprofile_img = (!empty($subscriber_result->sq_u_profile_picture)) ? $subscriber_result->sq_u_profile_picture : ''; ?>
...
<script>
    $(document).ready(function() {
        ...
        $('#current_password').on('keyup', function() {
            ...
            if (current_password !== '') {
                $.ajax({
                    url: '<?php echo base_url('verify_current_password'); ?>',
                    type: 'POST',
                    data: {
            ...
            if (isValid) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '<?php echo base_url('profile-stting'); ?>',
                            type: 'POST',
                            data: {
                                current_password: current_password,
