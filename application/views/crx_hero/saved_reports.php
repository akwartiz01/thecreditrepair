                            ...
                            <table class="table custom-table mb-0 w-100 credit_report_table" id="credit_report_table">
                                ...
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th style="text-align: center !important;">Provider Name</th>
                                        <th style="text-align: center !important;">Added Date</th>
                                    ...
                                    ?>
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center !important;">CRX Hero Score</td>
                                                <td style="text-align: center !important;"><?php echo $reports[0]->created_at; ?></td>
                                                <td style="text-align: center !important;">
                                                    <a href="<?php echo base_url('CrxHero/CrxHero/view_credit_report/' . $reports[0]->userId . '/' . urlencode(basename($reports[0]->credit_report_path))); ?>" class="btn btn-secondary btn-view-report" style="color: white !important;">View</a>

                                                    <a href="<?php echo $reports[0]->credit_report_path; ?>" class="btn btn-primary" download>Download</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
